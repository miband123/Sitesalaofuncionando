...
const Pricing = () => {
  const startFeatures = [
    ...
    "Domínio personalizado (seusalão.salonclick.com.br)",
  ...
  const premiumFeatures = [
    "Tudo do Plano Start +",
    "Controle de leads com botão de WhatsApp",
    "💬 Confirmação automatica no WhatsApp",
    "📅 Adição automática no Google Agenda",
